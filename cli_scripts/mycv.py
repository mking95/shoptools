...
def feature_detection(img):
    ...
    parser.add_argument('--input', help='Path to input image.', default='kk/vprez_121816_1_800.jpg')
...
def feat2d(img1,img2):
    from __future__ import print_function
    import cv2 as cv
    import numpy as np
    import argparse
    parser = argparse.ArgumentParser(description='Code for Feature Matching with FLANN tutorial.')
    parser.add_argument('--input1', help='Path to input image 1.', default=img1)
    parser.add_argument('--input2', help='Path to input image 2.', default=img2')
    args = parser.parse_args()
